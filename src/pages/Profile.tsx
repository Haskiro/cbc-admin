...
import {getUserInfo} from "../store/slices/authSlice.ts";
            ...
            <div className="mt-3">
                ...
                {status === "succeeded" && user ? <div>
                    <div className="flex-col max-w-[400px] gap-1 p-4 rounded-xl bg-[#F6FBFF]">
                        ...
                        <p className="text-[#04764E] font-semibold text-[18px]">Дата регистрации: {dateFormatter(new Date(user.createdAt))}</p>
                    </div>
                </div> : null}
            </div>
            </div>
